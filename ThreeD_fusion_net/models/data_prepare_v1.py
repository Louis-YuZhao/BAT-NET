...
def get_training_and_validation_data(data_file, outputfolder, n_labels, labels, training_list, validation_list, 
                                    ...
                                    training_patch_start_offset = None, skip_blank = True, unlabel=False):
    """
    ...
    if not unlabel:
        ...
        train_patch_data_file = os.path.join(outputfolder,'unlabeled_train_patch_data_save.h5')
        val_patch_data_file = os.path.join(outputfolder,'unlabeled_val_patch_data_save.h5')
