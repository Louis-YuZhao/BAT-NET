...
config = dict()
config["seed"] = 0 #set seed for reproduction
...
config["initial_learning_rate"] = 4e-4
...
config["unnorm_data_file"] = os.path.abspath("../resultData"+"/BAT_unnorm_data.h5")
config["model_file"] = os.path.abspath("../resultData" +"/BAT_Combined_model_plus_augmentation.h5")
